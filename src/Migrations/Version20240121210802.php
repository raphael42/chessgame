 ...
 */
final class Version20240121210802 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE game (id INT AUTO_INCREMENT NOT NULL, url VARCHAR(200) NOT NULL, increment INT NOT NULL, fen VARCHAR(255) NOT NULL, time DOUBLE PRECISION DEFAULT NULL, date_insert DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
