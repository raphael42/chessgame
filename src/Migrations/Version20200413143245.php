 ...
 */
final class Version20200413143245 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE player ADD game_creator TINYINT(1) NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE player DROP game_creator');
    }
}
